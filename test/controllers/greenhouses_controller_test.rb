...
class GreenhousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create greenhouse" do
    assert_difference('Greenhouse.count') do
      post greenhouses_url, params: { greenhouse: { description: @greenhouse.description, name: @greenhouse.name } }
    end
  ...
  test "should update greenhouse" do
    patch greenhouse_url(@greenhouse), params: { greenhouse: { description: @greenhouse.description, name: @greenhouse.name } }
