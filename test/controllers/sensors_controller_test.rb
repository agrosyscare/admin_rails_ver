...
class SensorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post sensors_url, params: { sensor: { arduino_id: @sensor.arduino_id, environmental_condition_id: @sensor.environmental_condition_id, model: @sensor.model, serial: @sensor.serial } }
    end
  ...
  test "should update sensor" do
    patch sensor_url(@sensor), params: { sensor: { arduino_id: @sensor.arduino_id, environmental_condition_id: @sensor.environmental_condition_id, model: @sensor.model, serial: @sensor.serial } }
