...
class FloorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create floor" do
    assert_difference('Floor.count') do
      post floors_url, params: { floor: { greenhouse_id: @floor.greenhouse_id, name: @floor.name, plant_type: @floor.plant_type } }
    end
  ...
  test "should update floor" do
    patch floor_url(@floor), params: { floor: { greenhouse_id: @floor.greenhouse_id, name: @floor.name, plant_type: @floor.plant_type } }
